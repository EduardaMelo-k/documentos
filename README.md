...
Apresentação curricular para oportunidades de estágio, vagas iniciais e networking profissional na área de tecnologia.

---

## 2. `APRESENTAÇÃO PROFISSIONAL.pdf`
Apresentação profissional em formato visual/slides contendo resumo pessoal, objetivos, competências técnicas e projetos acadêmicos.
...
### Objetivo do Documento
Documento visual para apresentações acadêmicas, networking, entrevistas e processos seletivos.
...
- Construção de portfólio inicial na área de tecnologia
...
- Interesse em experiências práticas e desenvolvimento técnico
